        ...
        try {
            ...
            $pdo->exec("
                create table if not exists global.type_attributes (
                    ...
                    name text not null,
                    kind text not null check (kind in ('text', 'number', 'boolean', 'date', 'date_range', 'select', 'file', 'graph', 'view', 'linked_notes', 'history', 'toc')),
            ...
            $pdo->exec("
                do \$\$ begin
                    ...
                    alter table global.type_attributes add constraint type_attributes_kind_check
                        check (kind in ('text', 'number', 'boolean', 'date', 'date_range', 'select', 'file', 'graph', 'view', 'linked_notes', 'history', 'toc'));
                end \$\$;
            ");
